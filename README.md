...
If you've been using promptonomicon, I suggest switching from promptonomicon to [Superpowers](https://github.com/obra/superpowers/tree/main) by @obra](https://github.com/obra). That's what I've done!
